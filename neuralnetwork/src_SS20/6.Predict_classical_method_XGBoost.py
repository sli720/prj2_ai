...
# =========== END CONFIG ================
logger = get_logger("Predict with XGBoost")
...
logger.info("Loading best parameter set for XGBoost from: " + output_dir_path + 'XGBoostClassifier_best_parameter_set.pkl')
clf2 = load(os.path.join(output_dir_path + 'XGBoostClassifier_best_parameter_set.pkl'))
