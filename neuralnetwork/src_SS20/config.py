...
#UPDATE_SS20: Commented out the following command
...
label_number_assocation["dos-goldeneye"] = 6        # 40668 occurences
...
#UPDATE_SS20: specify only the relevant labels for the dataset
labels_to_use = ["benign", "bot", "ssh-bruteforce", "dos-goldeneye"]
...
#UPDATE_SS20: Adapt the value for currentSystem
currentSystem = "SS20"    # "Server" ... our server, "PC1" ... rene laptop, "PC2" ... rene pc
...
#UPDATE_SS20: Specify appropriate paths
elif currentSystem == "SS20":
    csv_dir_path = "C:\\Users\mwech\\PycharmProjects\\AISecSS20\\Daten"
    output_dir_path = "C:\\Users\mwech\\PycharmProjects\\AISecSS20\\Daten\\NewProject"
    log_dir = "C:\\Users\mwech\\PycharmProjects\\AISecSS20\\Daten\\Logs"
else:
