...
data_train = load_dataset(file_path_trainset, already_preprocessed = True)
data_test = load_dataset(file_path_testset, already_preprocessed = True)
...
#UPDATE_SS20: Weights are adapted, because less classes are available in the dataset
my_weights = {0: 1, 4:1 , 5:1, 6:1}
